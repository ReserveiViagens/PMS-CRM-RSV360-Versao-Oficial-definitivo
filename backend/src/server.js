...
const crmAnalyticsRoutes = require("./routes/crm-analytics");
...
checkAndUseRoute("/api/interactions", interactionsRoutes, true);
checkAndUseRoute("/api/crm-analytics", crmAnalyticsRoutes, true);
checkAndUseRoute("/api/sync", syncRoutes, true);
checkAndUseRoute("/api/integration", integrationRoutes, true);
